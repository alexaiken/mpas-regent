...
task load_mesh(cell_region : region(ispace(int1d), cell_fs), edge_region : region(ispace(int1d), edge_fs), vertex_region : region(ispace(int1d), vertex_fs))
...
task calculate_evc(cell_region : region(ispace(int1d), cell_fs), edge_region : region(ispace(int1d), edge_fs), vertex_region : region(ispace(int1d), vertex_fs))
where reads writes(cell_region, edge_region, vertex_region) do
...
task partition_regions(num_partitions : int, cell_region : region(ispace(int1d), cell_fs), edge_region : region(ispace(int1d), edge_fs), vertex_region : region(ispace(int1d), vertex_fs))
where reads writes(cell_region, edge_region, vertex_region) do
  -----------------------------------
  ----- Copy Neighbours -----
  -----------------------------------
...
task write_output(cell_region : region(ispace(int1d), cell_fs), edge_region : region(ispace(int1d), edge_fs), vertex_region : region(ispace(int1d), vertex_fs))
where reads writes(cell_region, edge_region, vertex_region) do
  ...
  -- Close the file
  file_close(ncid_copy)cio.printf("Successfully written netcdf file!\n")
