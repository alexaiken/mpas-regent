...
When you get to the stage where you want to understand the MPAS codebase, we have a [google doc](https://docs.google.com/document/d/1yF4sEZyL1xUkHHfx-uYcRANpZyboRIZo3iiaydksnlw/edit).
...
When you log into Sherlock again, you'll have to allocate a node again.
