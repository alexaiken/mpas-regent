...
I would start by going [here](https://mpas-dev.github.io/) and poking around, especially the links about the atmospheric model.

Then, you can skim through the tutorial [here](http://www2.mmm.ucar.edu/projects/mpas/tutorial/Boulder2019/index.html). File 4 in particular is very helpful for understanding the mesh structure.
